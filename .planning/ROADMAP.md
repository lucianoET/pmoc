...
- [ ] 06-04-PLAN.md — Auditoria de fechamento: roteiro manual em `TESTES.md`, não regressão da refrigeração e atualização de documentação e requisitos (PLAT-04, PLAT-05, PLAT-15, PLAT-16)
