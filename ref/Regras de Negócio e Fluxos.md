...
> **Nota:** Fonte canônica deste documento está em `cmasm.erp/Regras de Negocio e Fluxos.md`. Esta cópia é espelho mantido junto às demais referências de `pmoc.refs/`.
